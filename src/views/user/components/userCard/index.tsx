          ...
          options={[
            {
              label: 'Profile',
              value: 'Profile',
              icon: <SvgIcon className="profile" name="profile" size={24} />,
            },
            {
              label: 'Followers',
              value: 'Followers',
            ...
            },
            {
              label: 'Friends',
              value: 'Friends',
              icon: <SvgIcon className="profile" name="friends" size={24} />,
            },
            {
              label: 'Gallery',
              value: 'Gallery',
              icon: <SvgIcon className="profile" name="gallery" size={24} />,
            },
          ]}
        />
      </Card>
