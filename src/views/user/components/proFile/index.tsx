        ...
        <Flex gap={16} vertical>
          <Card>
            <Flex align="middle" justify="space-evenly">
              <UserFooter name="Follower" count={12} />
              <Divider style={{ height: 'auto' }} type="vertical" />
              <UserFooter name="Following" count={112} />
            </Flex>
          </Card>
          <Card title={t('关于我')}>
            <Text type="secondary">
            ...
            <Flex gap={16} vertical>
              ...
              <Flex justify="space-between" align="content-center">
                ...
                <div>
                  ...
                  <Button shape="circle" type="text" icon={<ShareAltOutlined />} />
                </div>
              </Flex>
