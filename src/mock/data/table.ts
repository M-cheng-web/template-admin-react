...
const getEducation = () => {
  const educationList = [t('小学'), t('初中'), t('高中'), t('专科'), t('本科'), t('研究生')];
...
const articleListData = [
  ...
  },
  {
    ...
    is_gfw: 0,
    title: t('3D数字孪生 - Three.js 项目实战之相机控制器（五）'),
    brief_content: t(
  ...
  },
  {
    ...
    is_gfw: 0,
    title: t('3D数字孪生 - Three.js 项目实战之相机（四）'),
    brief_content: t(
  ...
  },
  {
    ...
    is_gfw: 0,
    title: t('3D数字孪生 - Three.js 项目实战之场景材质（三）'),
    brief_content: t(
  ...
  },
  {
    ...
    is_gfw: 0,
    title: t('3D数字孪生 - Three.js 项目实战之场景光源（二）'),
    brief_content: t(
  ...
  },
  {
    ...
    is_gfw: 0,
    title: t('3D数字孪生 - Three.js 项目介绍与基础环境搭建（一）'),
    brief_content: t(
  ...
  },
  {
    ...
    title: t('konva绘制图像标定'),
    brief_content: t(
      '视频流标定工具，矩形与多边形绘制。仓库地图动态标注摄像机位置。konva.js konva-react实战',
    ),
